...
#include <memory>
#include "../../../src/widgets/HeaderWidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_HeaderWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_HeaderWidget_t qt_meta_stringdata_HeaderWidget = {
    {
QT_MOC_LITERAL(0, 12), // "HeaderWidget"
QT_MOC_LITERAL(13, 11), // "backClicked"
QT_MOC_LITERAL(25, 0) // ""

    },
    "HeaderWidget\0backClicked\0"
};
...
void HeaderWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HeaderWidget::backClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject HeaderWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_HeaderWidget.offsetsAndSize,
    qt_meta_data_HeaderWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_HeaderWidget_t
, QtPrivate::TypeAndForceComplete<HeaderWidget, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
